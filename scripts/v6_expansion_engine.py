...
def fetch_odds_io():
    ...
    for league in odds_io_pick_leagues():
        ...
        for ev in near_events[:ODDS_IO_MAX_EVENTS]:
            ...
            games.append({'id': 'oddsio_' + str(oid), 'source': 'odds-api.io', 'sport_key': 'soccer_odds_api_io', 'league': league, 'home_team': home, 'away_team': away, 'commence_time': odds.get('date') or ev.get('date'), 'bookmakers': books})
...
def collect_candidates(): return parse_games(fetch_odds_io())
