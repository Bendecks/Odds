...
def main():
    ...
    for x in signals:
        ...
        row={'signal_key':key,'event':x.get('event'),'market':x.get('market'),'pick':x.get('pick'),'taken_odds':x.get('odds'),'commence_time':x.get('commence_time'),'model_version':x.get('model_version')}
