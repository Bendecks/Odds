...
class DevigPagesTests(unittest.TestCase):
    def test_pages_workflow_publishes_shadow_report_when_present(self):
        ...
        self.assertIn('output/football_model_readiness.json',workflow)
    ...
    def test_dashboard_has_shadow_report_mount_point(self):
        ...
        self.assertIn('id="provider-metadata"',html)
        ...
        self.assertIn('id="football-model-readiness"',html)
    ...
    def test_dashboard_loads_shadow_report_fail_soft(self):
        ...
        self.assertIn('providerMetadataSummary',app)
        self.assertIn('Provider metadata:',app)
        ...
        self.assertIn('loadFootballModelReadiness',app)
        self.assertIn('output/football_model_readiness.json',app)
        self.assertIn('Football model readiness',app)
